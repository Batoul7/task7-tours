  ...
  return (
    <section className=' relative bg-offers bg-cover bg-center h-[450px] mt-[100px] py-15 px-10 mylg:px-40 3xl:px-63 
      ...
      <div className='w-[569px] p-7.5 bg-bgbox rounded-3xl text-center flex flex-col gap-8'>
        <h4 className='text-2xl lg:text-32 text-mygray font-extrabold leading-10'>Get Special Offers for Organizations</h4>
        <p className='text-base lg:text-lg leading-[26px]'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s.</p>
